...
class CarouselItemLocalizationAPIUnitTest(TestCase):
    ...
    def test_carousel_item_localization(self):
        ...
        # GET LOGS
        url = reverse('unicms_api:carousel-item-localization-logs',
                      kwargs={'carousel_id': carousel.pk,
                              'carousel_item_id': carousel_item.pk,
        ...
        # redis lock set
        ct = ContentType.objects.get_for_model(carousel_item_localization)
        data = {'content_type_id': ct.pk,
                'object_id': carousel_item_localization.pk}
