...
uniCMS is a Web Content Management System built on top of **Django Framework**, developed by 
young IT guys that think that a nowadays CMS should have the following features:
...
and smart developers, creating a website with uniCMS doesn't' require any development skill.
