...
class CarouselItemLinkLocalizationAPIUnitTest(TestCase):
    ...
    def test_carousel_item_link_localization(self):
        ...
        carousel_item_link_localization.is_lockable_by(user)
        ...
        # redis lock set
        ct = ContentType.objects.get_for_model(carousel_item_link_localization)
        data = {'content_type_id': ct.pk,
                'object_id': carousel_item_link_localization.pk}
